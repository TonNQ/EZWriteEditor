interface SortNumberDescProps {
  width?: number
  height?: number
  className?: string
}

const SortNumberDesc = ({ width = 24, height = 24, className = 'text-gray-600' }: SortNumberDescProps) => {
  return (
