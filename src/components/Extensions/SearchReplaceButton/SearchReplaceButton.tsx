          ...
          <div className='space-y-4'>
            ...
            <div className='mb-4 flex items-center space-x-2'>
              <label className='inline-flex cursor-pointer items-center'>
                ...
                />
                <div className='peer relative h-5 w-9 rounded-full bg-gray-200 peer-checked:bg-gray-500 peer-focus:outline-none after:absolute after:start-[2px] after:top-[2px] after:h-4 after:w-4 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[""] peer-checked:after:translate-x-full peer-checked:after:border-white rtl:peer-checked:after:-translate-x-full'></div>
            ...
            <div className='flex gap-2'>
              <button
                type='button'
                className={cn(
                  'flex-1 rounded bg-gray-200 px-4 py-2 text-sm font-medium text-gray-800 hover:bg-gray-300',
                  {
